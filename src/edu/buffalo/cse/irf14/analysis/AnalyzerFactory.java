...
public class AnalyzerFactory {
	...
	public Analyzer getAnalyzerForField(FieldNames name, TokenStream stream) {
		if (name.equals(FieldNames.CATEGORY)) {
		...
		} else if (name.equals(FieldNames.CONTENT)
				|| name.equals(FieldNames.TITLE)
				|| name.equals(FieldNames.AUTHORORG)
				|| name.equals(FieldNames.NEWSDATE)) {
